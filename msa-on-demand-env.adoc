...
* Explain that the service catalog by default among other things the templates that are available 
in the *openshift* namespaces since they are global and available to all projects and 
users. However in this project you have a template for the *inventory* servic that the developer has created. 
You can deploy project templates by clicking on *Add to Project* and then *Add from Project*. 

image::msa-ondemand-template-from-project.png[Application Template Browse,width=800,align=center]

* Click on the *inventory* template and then on *Next* and then *Next*

image::msa-ondemand-template-inventory.png[Application Template,width=800,align=center]
